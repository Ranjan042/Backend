    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label
            htmlFor="login-email"
            className="block text-[10px] font-bold uppercase tracking-[0.15em] text-gray-900 mb-2"
          >
            Email
          </label>
          <input
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label
              ...
              className="block text-[10px] font-bold uppercase tracking-[0.15em] text-gray-900"
            >
              Password
            </label>
            <button
